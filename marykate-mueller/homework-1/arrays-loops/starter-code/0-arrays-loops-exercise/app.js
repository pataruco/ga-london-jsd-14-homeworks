...
console.log; log({ image 1, image2 });
...
let students = ['Alex', 'Jay', 'AB', 'Mary Kate', 'Mareen'];

console.log(`last item of students array is ${students.pop()}`);
console.log(`last item of students array is ${students.{ students.length - 1] }
...
const numbers = [1, 2, 3, 4]; // 10 / 4 = 2.5
...
let hundreths = [100, 200, 300, 400, 500];

function addFive(item) {
  console.log({ item })
}

hundreths.forEach(addFive)
// ____________________________________________________________________________
